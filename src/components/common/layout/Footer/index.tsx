        ...
        <InnerContainer>
          ...
          <LinkContainer>
            ...
            {socialLinks?.gamejoltUrl && (
              <Link href={socialLinks.gamejoltUrl} target="_blank" rel="noreferrer">
                Gamejolt
              </Link>
            )}
            {socialLinks?.itchUrl && (
              <Link href={socialLinks.itchUrl} target="_blank" rel="noreferrer">
                Itch.io
              </Link>
            )}
            {socialLinks?.youtubeUrl && (
              <Link href={socialLinks.youtubeUrl} target="_blank" rel="noreferrer">
                Youtube
              </Link>
            )}
            {socialLinks?.steamUrl && (
              <Link href={socialLinks.steamUrl} target="_blank" rel="noreferrer">
                Steam
              </Link>
            )}
            {socialLinks?.facebookUrl && (
              <Link href={socialLinks.facebookUrl} target="_blank" rel="noreferrer">
                Facebook
              </Link>
            )}
            {socialLinks?.indieDbUrl && (
              <Link href={socialLinks.indieDbUrl} target="_blank" rel="noreferrer">
                IndieDB
              </Link>
            )}
          </LinkContainer>
